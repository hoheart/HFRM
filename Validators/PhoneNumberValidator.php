...
class PhoneNumberValidator extends ValidatorService {
	 ...
	 */
	public $phonePattern = '/^(13[0-9]|15[012356789]|168|17[0678]|18[0-9]|14[57])[0-9]{8}$/';

	/**
	 * 多个手机号同时验证
	 * @var string 验证整数正则表达式
	 */
	public $multiPhonePattern = '/^(13[0-9]|15[012356789]|168|17[0678]|18[0-9]|14[57])[0-9]{8}(?:\,(13[0-9]|15[012356789]|168|17[0678]|18[0-9]|14[57])[0-9]{8})*$/';
